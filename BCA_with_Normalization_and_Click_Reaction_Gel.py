...
def run(protocol: protocol_api.ProtocolContext):
    ...
    plate2 = protocol.load_labware('corning_96_wellplate_360ul_flat', location='C3') #on heatshaker
    #plate2 = protocol.move_labware(labware= plate2, new_location=hs_adapter) #on heatshaker
...
# Iterate over the sample_map list
    ...
    protocol.move_labware(labware=plate2, new_location=hs_adapter)
