...
def run(protocol: protocol_api.ProtocolContext):
    ...
    normalized_samples = unknown_samples[['Sample', 'Protein Concentration (mg/mL)', 'Sample Volume (mL)', 'Diluent Volume (mL)','Sample Volume (uL)','Sample Volume (uL)']].reset_index().drop(columns='index')
    ...
    print(unknown_samples[['Sample', 'Protein Concentration (mg/mL)', 'Sample Volume (mL)', 'Diluent Volume (mL)','Sample Volume (uL)','Sample Volume (uL)']])
